"use strict";(()=>{var ya=`/* eslint-disable */
/**
...
`)}function ia(t,n,r){if(n.length===0)return t;let a=t.concat(n);return a.length>r?a.slice(a.length-r):a}function la(t){let n=t.items,[r,a]=h([]),[c,u]=h("connecting"),[s,d]=h(""),[f,x]=h(!1),[p,w]=h(0),[E,P]=h(!1),[R,J]=h(!1),[b,B]=h("arrival"),[O,j]=h(0),C=A([]),ne=A(new Map),m=A(!1),v=A([]),_=A("arrival"),H=A([]),U=A(null),q=A(null),re=n.map(M=>M.id).join(","),ke=pn();L(()=>{if(!ke)return;if(n.length===0){u("empty");return}if(typeof EventSource!="function"){u("unsupported");return}u("connecting"),C.current=[],ne.current=new Map,v.current=[],a([]),w(0),P(!1),H.current=[],U.current!==null&&(clearTimeout(U.current),U.current=null);let M=0,oe=0,ee=n.map(Y=>{let rt=Y.composeService===null?Y.name:Y.composeService,fe=new EventSource($t("/logs/stream",{target:t.target,id:Y.id,tail:100,timestamps:1})),we=D=>{if(D.length===0)return;let Z=_.current==="time"?Mt(C.current,D,gn):C.current.concat(D),ae=Z.length>Ee?Z.slice(Z.length-Ee):Z;C.current=ae,ae.length!==Z.length&&P(!0),a(ae)},ce=D=>{if(_.current!=="time"){we(D);return}H.current=H.current.concat(D),U.current===null&&(U.current=setTimeout(()=>{U.current=null;let Z=H.current;H.current=[],we(kn(Z))},un))},Ce=D=>{let ae=((ne.current.get(Y.id)??"")+D).split(`
`);if(ne.current.set(Y.id,ae.pop()??""),ae.length===0)return;let Ne=ae.map(_e=>{let ve=na(_e);return{service:rt,text:ve.text,ts:ve.ts}});if(m.current){let _e=v.current.concat(Ne);v.current=_e.length>Ee?_e.slice(_e.length-Ee):_e,w(ve=>v.current.length-ve>=5||ve===0?v.current.length:ve);return}ce(Ne)};return fe.addEventListener("line",D=>{let Z=null;try{Z=JSON.parse(D.data)}catch{return}Z===null||typeof Z!="object"||(typeof Z.d=="string"?Ce(Z.d):typeof Z.e=="string"&&Ce(Z.e))}),fe.addEventListener("end",()=>{try{fe.close()}catch{}oe+=1,oe>=n.length&&u("closed")}),fe.addEventListener("error",D=>{typeof D.data=="string"&&D.data!==""?u("partial"):u("reconnecting")}),fe.onopen=()=>{M+=1,u("open")},()=>{try{fe.close()}catch{}}});return()=>{for(let Y of ee)Y()}},[ke,t.target,re]),L(()=>{if(f)return;let M=q.current;M!==null&&(M.scrollTop=M.scrollHeight)},[f,r]);let Ye=()=>{let M=!m.current;if(m.current=M,x(M),M)return;let oe=v.current;if(v.current=[],w(0),oe.length>0){let ee=ia(C.current,oe,Ee);C.current=ee,a(ee)}requestAnimationFrame(()=>{let ee=q.current;ee!==null&&(ee.scrollTop=ee.scrollHeight)})},me=s.trim().toLowerCase(),Ae=ra(r,O),be=me===""?Ae:Ae.filter(M=>M.text.toLowerCase().indexOf(me)>=0||M.service.toLowerCase().indexOf(me)>=0),He=be.length>dt?be.slice(-dt):be,Ge=()=>{let M=b==="time"?"arrival":"time";_.current=M,B(M),U.current!==null&&(clearTimeout(U.current),U.current=null);let oe=H.current;if(H.current=[],oe.length>0){let ee=Mt(C.current,oe,gn),Y=ee.length>Ee?ee.slice(ee.length-Ee):ee;C.current=Y,a(Y)}if(M==="time"){let ee=Mt([],C.current,C.current.length);C.current=ee,a(ee)}},ge=M=>{let oe=oa(He,{format:M,target:t.target,targetLabel:t.targetLabel,items:n}),ee=new Date().toISOString().replace(/[:.]/g,"-").slice(0,19);Sa("docker-logs-"+ee+(M==="md"?".md":".log"),oe)},ze=()=>c==="open"?"\u5DF2\u8FDE\u63A5 "+String(n.length)+" \u6761\u5BB9\u5668\u65E5\u5FD7\u6D41\uFF08docker logs -f\uFF09":c==="connecting"?"\u6B63\u5728\u8FDE\u63A5\u5BB9\u5668\u65E5\u5FD7\u6D41\u2026":c==="reconnecting"?"\u90E8\u5206\u8FDE\u63A5\u4E2D\u65AD\uFF0C\u6B63\u5728\u81EA\u52A8\u91CD\u8FDE\u2026":c==="partial"?"\u90E8\u5206\u5BB9\u5668\u65E5\u5FD7\u6D41\u51FA\u9519":c==="closed"?"\u5168\u90E8\u5BB9\u5668\u65E5\u5FD7\u6D41\u5DF2\u7ED3\u675F":c==="unsupported"?"\u5F53\u524D\u73AF\u5883\u4E0D\u652F\u6301 EventSource":c==="empty"?"\u8BE5\u9879\u76EE\u6CA1\u6709\u53EF\u805A\u5408\u7684\u5BB9\u5668":"\u805A\u5408\u65E5\u5FD7";return i("div",{className:"dk_logs",children:[E?e(X,{kind:"warn",title:"\u805A\u5408\u65E5\u5FD7\u8D85\u8FC7 "+String(Ee)+" \u884C\uFF0C\u5DF2\u4E22\u5F03\u6700\u65E9\u5185\u5BB9"}):null,i("div",{className:"dk_filterBar",children:[i("div",{className:"dk_filterWrap",children:[e("input",{className:"dk_input dk_filterInput",placeholder:"\u8FC7\u6EE4\u670D\u52A1\u540D / \u65E5\u5FD7\u5185\u5BB9\u2026",value:s,onChange:M=>d(M.target.value),onKeyDown:M=>{M.key==="Escape"&&s!==""&&(M.stopPropagation(),d(""))}}),s===""?null:e("button",{type:"button",className:"dk_filterClear",title:"\u6E05\u7A7A\u8FC7\u6EE4",onClick:()=>d(""),children:e("span",{className:"dk_iconGlyph",dangerouslySetInnerHTML:{__html:Re}})},"clear")]}),e("button",{type:"button",className:"dk_pill dk_pillFollow","data-on":f?"0":"1","data-paused":f?"1":void 0,title:f?"\u6062\u590D\u5B9E\u65F6\uFF08\u4F1A\u4E00\u6B21\u6027\u663E\u793A\u6682\u505C\u671F\u95F4\u6512\u4E0B\u7684 "+String(p)+" \u884C\u5E76\u56DE\u5230\u5E95\u90E8\uFF09":"\u6682\u505C\uFF08\u51BB\u7ED3\u5F53\u524D\u753B\u9762\uFF1A\u65B0\u65E5\u5FD7\u7EE7\u7EED\u63A5\u6536\u4F46\u4E0D\u8FFD\u52A0\uFF0C\u907F\u514D\u8BFB\u5C4F\u88AB\u9876\u8D70\uFF09",onClick:Ye,children:f?p>0?"\u5DF2\u6682\u505C +"+String(p):"\u5DF2\u6682\u505C":"\u5B9E\u65F6"}),e("button",{type:"button",className:"dk_pill","data-on":R?"1":"0",title:R?"\u9690\u85CF\u6BCF\u884C\u65F6\u95F4\u6233":"\u663E\u793A\u6BCF\u884C\u65F6\u95F4\u6233\uFF08\u65F6\u95F4\u6233\u59CB\u7EC8\u968F\u6D41\u63A5\u6536\uFF0C\u53EA\u5F71\u54CD\u663E\u793A\uFF09",onClick:()=>J(M=>!M),children:"\u65F6\u95F4\u6233"}),e("button",{type:"button",className:"dk_pill","data-on":b==="time"?"1":"0",title:b==="time"?"\u6309\u5230\u8FBE\u987A\u5E8F\u663E\u793A\uFF08\u5B9E\u65F6\u8DDF\u968F\u96F6\u5EF6\u8FDF\uFF09":"\u6309\u5BB9\u5668\u65F6\u95F4\u6233\u5408\u5E76\uFF08\u8DE8\u5BB9\u5668\u6210\u4E00\u6761\u771F\u65F6\u95F4\u7EBF\uFF0C\u4EE3\u4EF7\u7EA6 "+String(un)+"ms \u5EF6\u8FDF\uFF09",onClick:()=>Ge(),children:b==="time"?"\u6309\u65F6\u95F4":"\u6309\u5230\u8FBE"}),e("select",{className:"dk_select dk_selectSm",value:String(O),title:"\u6309\u65E5\u5FD7\u7EA7\u522B\u8FC7\u6EE4\uFF08\u65E0\u7EA7\u522B\u524D\u7F00\u7684\u884C\u59CB\u7EC8\u4FDD\u7559\uFF09",onChange:M=>j(Number(M.target.value)),children:[e("option",{value:"0",children:"\u5168\u90E8\u7EA7\u522B"},"all"),e("option",{value:"3",children:"WARN+"},"warn"),e("option",{value:"4",children:"ERROR+"},"error")]}),e("button",{type:"button",className:"dk_chip",disabled:He.length===0,title:"\u5BFC\u51FA\u5F53\u524D\u663E\u793A\u5185\u5BB9\u4E3A .log\uFF08\u7EAF\u6587\u672C\uFF09",onClick:()=>ge("log"),children:"\u2B07 .log"}),e("button",{type:"button",className:"dk_chip",disabled:He.length===0,title:"\u5BFC\u51FA\u5F53\u524D\u663E\u793A\u5185\u5BB9\u4E3A .md\uFF08\u5E26\u6765\u6E90\u4E0E\u884C\u6570\u8868\u5934\uFF0C\u9002\u5408\u5F53\u5DE5\u5355\u9644\u4EF6\uFF09",onClick:()=>ge("md"),children:"\u2B07 .md"}),e("span",{className:"dk_filterCount",children:me===""&&O===0?String(r.length)+" \u884C":String(be.length)+" / "+String(r.length)+" \u884C"})]}),e("div",{className:"dk_followState","data-state":c==="open"?"open":c==="closed"?"closed":"connecting",children:ze()}),e("div",{className:"dk_logBody",ref:q,onContextMenu:M=>Qn(M,q.current,{target:t.target,targetLabel:t.targetLabel??"",containers:n,filtered:me!==""}),children:[He.length===0?e("div",{className:"dk_logLine",children:c==="open"?"\u7B49\u5F85\u65E5\u5FD7\u2026":ze()},"empty"):He.map((M,oe)=>ir(M,oe,me,R))]})]})}function Er(t,n){let r=typeof t.image=="string"?t.image:"",a=typeof t.composeProject=="string"?t.composeProject:"";return i("span",{className:"dk_activityItem","data-action":String(t.action??"").split(":")[0].trim(),title:a===""?r:r+" \xB7 "+a,children:[e("span",{className:"dk_activityTime",children:Wa(t.time)}),e("span",{className:"dk_activityName",children:t.name}),e("span",{className:"dk_activityAction",children:Ja(t)})]},String(n)+String(t.name)+String(t.time))}function Or(t){let n=t.open===!0,r=Array.isArray(t.events)?t.events:[],a=r.slice(0,Va);return i("div",{className:"dk_activity","data-open":n?"1":"0",children:[e("button",{type:"button",className:"dk_activityHead","aria-expanded":n,title:"\u5BB9\u5668\u4E8B\u4EF6\u6D3B\u52A8\uFF08docker events\uFF09\uFF1A\u70B9\u51FB\u6298\u53E0 / \u5C55\u5F00",onClick:t.onToggle,children:[e("span",{className:"dk_activityTitle",children:"\u6D3B\u52A8"}),e("span",{className:"dk_activityState","data-state":t.status??"",children:t.statusText??""}),e("span",{className:"dk_headerSpacer"}),e("span",{className:"dk_hint",children:r.length===0?"\u6682\u65E0\u4E8B\u4EF6":"\u6700\u8FD1 "+String(a.length)+" / "+String(r.length)+" \u6761"}),e("span",{className:"dk_activityChevron",dangerouslySetInnerHTML:{__html:On}})]}),n===!1?null:a.length===0?e("div",{className:"dk_activityEmpty",children:"\u6682\u65E0\u4E8B\u4EF6\uFF08\u5BB9\u5668\u7684 start / die / health \u7B49\u52A8\u4F5C\u4F1A\u51FA\u73B0\u5728\u8FD9\u91CC\uFF09"}):e("div",{className:"dk_activityList",children:a.map(Er)})]})}function Ir(t){let n=t.info,r=Array.isArray(t.presets)?t.presets:[],a=r.some(c=>c.count>0)||t.count>0;return i("div",{className:"dk_pickBar",children:[i("div",{className:"dk_pickRow",children:[e("span",{className:"dk_pickCount",children:"\u5DF2\u9009 "+String(t.count)+" \u4E2A\u5BB9\u5668"}),n.hint===""?null:e("span",{className:"dk_hint dk_pickHint",children:n.hint}),e("span",{className:"dk_headerSpacer"}),e("button",{type:"button",className:"dk_btn dk_btnPrimary",disabled:n.canRun!==!0,title:n.hint!==""?n.hint:n.canRun===!0?"\u628A\u6240\u9009\u5BB9\u5668\u7684\u65E5\u5FD7\u805A\u5408\u6210\u4E00\u6761\u6D41":"\u81F3\u5C11\u9009\u62E9 2 \u4E2A\u5BB9\u5668",onClick:t.onRun,children:"\u805A\u5408\u65E5\u5FD7"}),e("button",{type:"button",className:"dk_btn",onClick:t.onCancel,children:"\u53D6\u6D88"})]}),a?i("div",{className:"dk_pickPresets",children:[e("span",{className:"dk_pickPresetsLabel",children:"\u6309\u6761\u4EF6\u9009\u4E2D"}),...r.filter(c=>c.count>0).map(c=>e("button",{type:"button",className:"dk_chip",title:"\u5728\u5F53\u524D\u7B5B\u9009\u7ED3\u679C\u91CC\u52FE\u9009\u300C"+c.label+"\u300D\u7684\u5BB9\u5668\uFF08\u6700\u591A "+String(t.max??an)+" \u4E2A\u6D41\uFF09"+(c.over>0?"\uFF1B\u53E6\u6709 "+String(c.over)+" \u4E2A\u8D85\u51FA\u4E0A\u9650\u4E0D\u4F1A\u9009\u4E2D":""),onClick:()=>t.onPreset(c.key),children:c.label+" "+String(c.count)},c.key)),t.count>0?e("button",{type:"button",className:"dk_chip dk_chipQuiet",title:"\u6E05\u7A7A\u52FE\u9009",onClick:t.onClear,children:"\u6E05\u7A7A"},"clear"):null,t.notice===""?null:e("span",{className:"dk_hint dk_pickNotice",children:t.notice})]}):null]})}function Mr(t){return i("div",{className:"dk_detail",children:[i("div",{className:"dk_header dk_headerDetail",children:[e($,{icon:et,title:"\u8FD4\u56DE\u5BB9\u5668\u5217\u8868\uFF08\u9000\u51FA\u9009\u62E9\u6001\uFF09",onClick:t.onBack},"back"),e("span",{className:"dk_projectIcon",dangerouslySetInnerHTML:{__html:Ia}}),e("span",{className:"dk_detailTitle",children:"\u805A\u5408\u65E5\u5FD7 \xB7 "+String(t.items.length)+" \u4E2A\u5BB9\u5668"}),e("span",{className:"dk_detailSub",children:t.targetLabel??""}),e("span",{className:"dk_headerSpacer"}),t.docked===!0?null:e("button",{type:"button",className:"dk_iconBtn",title:"\u5173\u95ED\u9762\u677F",onClick:t.onClose,children:e("span",{className:"dk_iconGlyph",dangerouslySetInnerHTML:{__html:Re}})},"close")]}),e("div",{className:"dk_detailBody",children:e(la,{target:t.target,targetLabel:t.targetLabel,items:t.items})})]})}function Rr(t){let n=t.collapsed===!0;return i("div",{className:"dk_drawer","data-collapsed":n?"1":void 0,style:n||t.height===null?void 0:{height:String(t.height)+"px"},children:[e("div",{className:"dk_drawerResize",title:"\u62D6\u52A8\u8C03\u6574\u7EC8\u7AEF\u9AD8\u5EA6\uFF08\u53CC\u51FB\u6298\u53E0 / \u5C55\u5F00\uFF09",onMouseDown:t.onResizeStart,onDoubleClick:t.onToggleCollapse},"resize"),i("div",{className:"dk_drawerHead",children:[e("span",{className:"dk_drawerIcon",dangerouslySetInnerHTML:{__html:Oa}}),e("span",{className:"dk_drawerTitle",title:t.label,children:t.label}),e("span",{className:"dk_drawerHint",children:n?"\u5DF2\u6298\u53E0 \xB7 \u4F1A\u8BDD\u4FDD\u6301\u8FD0\u884C":"\u7531\u7EC8\u7AEF\u9762\u677F\u627F\u8F7D \xB7 \u6298\u53E0\u4FDD\u7559\u4F1A\u8BDD"}),e("span",{className:"dk_headerSpacer"}),e("button",{type:"button",className:"dk_iconBtn dk_drawerFold",title:n?"\u5C55\u5F00\u7EC8\u7AEF\uFF08\u4F1A\u8BDD\u672A\u4E2D\u65AD\uFF09":"\u6298\u53E0\u7EC8\u7AEF\uFF08\u4F1A\u8BDD\u4FDD\u6301\u8FD0\u884C\uFF09",onClick:t.onToggleCollapse,children:e("span",{className:"dk_iconGlyph",dangerouslySetInnerHTML:{__html:On}})},"fold"),e("button",{type:"button",className:"dk_iconBtn",title:"\u7ED3\u675F\u7EC8\u7AEF\u4F1A\u8BDD\u5E76\u6536\u8D77\u62BD\u5C49",onClick:t.onClose,children:e("span",{dangerouslySetInnerHTML:{__html:Re}})},"close")]}),e("div",{className:"dk_drawerBody",ref:t.hostRef})]})}let hn={view:"containers",search:"",stateFilter:"all",all:!0,detail:null,activityOpen:!0};function nt(t,n){let[r,a]=h(()=>t in hn?hn[t]:n);return L(()=>{hn[t]=r},[t,r]),[r,a]}let da=k.createContext(!0);function pn(){return k.useContext(da)}function mn(t){let[n,r]=h(null),[a,c]=h([]),u=typeof t.initialTarget=="string"?t.initialTarget.trim():"",s=A(u!==""?u:Ta()),[d,f]=h(s.current),x=t.sessionHint!==void 0&&(t.initialTarget??"")==="",[p,w]=nt("view","containers"),[E,P]=h([]),[R,J]=h(""),b=A(""),B=de(o=>{b.current=o,J(o)},[]),[O,j]=h([]),[C,ne]=h([]),[m,v]=h([]),[_,H]=h([]),[U,q]=h(null),[re,ke]=h(null),[Ye,me]=h(null),[Ae,be]=h(null),[He,Ge]=h(!1),[ge,ze]=h(!1),[M,oe]=h([]),[ee,Y]=h(""),[rt,fe]=h(!1),[we,ce]=h(!1),[Ce,D]=h(""),[Z,ae]=h(""),[Ne,_e]=nt("all",!0),[ve,Fe]=nt("search",""),[We,vn]=nt("stateFilter","all"),[Te,Rt]=h(!1),[Bt,gt]=h([]),ht=pn(),[Ve,he]=h(""),[At,bn]=nt("activityOpen",!0),pt=A(null),Pt=A(""),[Je,Pe]=nt("detail",null),[Dt,jt]=h(0),[ye,Se]=h(null),[Ht,zt]=h(!1),[Ft,Xe]=h({}),[Vt,_n]=h(""),[y,I]=h(""),[N,z]=h(""),F=A(!0),G=A(null);G.current===null&&(G.current=Ha());let[se,W]=h(null),V=A(null),[K,ue]=h(!1),[Ue,Wr]=h(null),[Jr,yn]=h(!1),ua=A(null),xn=A(!1);L(()=>()=>{F.current=!1},[]),L(()=>{if(se===null)return;let o=V.current;if(o===null)return;let g=null;try{g=qe.mount(o,se.options)}catch(S){ae("\u7EC8\u7AEF\u542F\u52A8\u5931\u8D25\uFF1A"+(S instanceof Error?S.message:String(S))),W(null);return}return()=>{try{g?.()}catch{}}},[se]);let Ur=o=>{if(o.button!==void 0&&o.button!==0)return;let g=o.currentTarget.parentElement,S=ua.current;if(g===null||S===null)return;o.preventDefault();let pe=o.clientY,ie=g.getBoundingClientRect().height,te=Math.max(160,Math.round(S.getBoundingClientRect().height*.75)),De=xe=>{let Me=Math.round(ie+(pe-xe.clientY));Wr(Math.min(te,Math.max(160,Me)))},qt=()=>{document.removeEventListener("mousemove",De),document.removeEventListener("mouseup",qt),document.body.style.userSelect=""};document.body.style.userSelect="none",document.addEventListener("mousemove",De),document.addEventListener("mouseup",qt)},Ke=()=>{if(se===null){t.onClose();return}yn(!0)};L(()=>{Q.config().then(o=>{let g=o.config;r(g),Array.isArray(g.targets)&&g.targets.length>0&&f(S=>Ln(g.targets,S,s.current,x)),En(g)}).catch(o=>D(o.message)),Q.targets().then(o=>{c(o.targets??[]),Hn=o.targets??[],f(g=>Ln(o.targets??[],g,s.current,x)),s.current=""}).catch(()=>{})},[]),L(()=>{d!==""&&La(d)},[d]);let mt=de(()=>{if(d==="")return Promise.resolve();let o=G.current.next();return ce(!0),Q.containers(d,Ne).then(g=>{!F.current||!G.current.isCurrent(o)||(P(g.containers??[]),B(d),D(""))}).catch(g=>{!F.current||!G.current.isCurrent(o)||(b.current!==d&&P([]),B(d),D(g.message))}).finally(()=>{F.current&&G.current.isCurrent(o)&&ce(!1)})},[d,Ne]),ft=de(()=>{if(d==="")return Promise.resolve();let o=G.current.next();return ce(!0),Q.images(d).then(g=>{!F.current||!G.current.isCurrent(o)||(ne(g.images??[]),B(d),D(""))}).catch(g=>{!F.current||!G.current.isCurrent(o)||(b.current!==d&&ne([]),B(d),D(g.message))}).finally(()=>{F.current&&G.current.isCurrent(o)&&ce(!1)})},[d]),Kt=de(()=>{if(d==="")return Promise.resolve();let o=G.current.next();return ce(!0),Q.networks(d).then(g=>{!F.current||!G.current.isCurrent(o)||(v(g.networks??[]),B(d),D(""))}).catch(g=>{!F.current||!G.current.isCurrent(o)||(b.current!==d&&v([]),B(d),D(g.message))}).finally(()=>{F.current&&G.current.isCurrent(o)&&ce(!1)})},[d]),Gt=de(()=>{if(d==="")return Promise.resolve();let o=G.current.next();return ce(!0),Q.volumes(d).then(g=>{!F.current||!G.current.isCurrent(o)||(H(g.volumes??[]),B(d),D(""))}).catch(g=>{!F.current||!G.current.isCurrent(o)||(b.current!==d&&H([]),B(d),D(g.message))}).finally(()=>{F.current&&G.current.isCurrent(o)&&ce(!1)})},[d]),wn=de(()=>{if(a.length===0)return j([]),Promise.resolve();let o=G.current.next();ce(!0),j(a.map(ie=>({name:ie.name,kind:ie.kind,label:ie.label,containers:[],attention:null,error:"",loaded:!1})));let g=a.length,S=()=>{g-=1,g===0&&F.current&&G.current.isCurrent(o)&&ce(!1)},pe=ie=>Q.attention(ie).then(te=>{!F.current||!G.current.isCurrent(o)||j(De=>wt(De,ie,{attention:te.items??[]}))}).catch(()=>{!F.current||!G.current.isCurrent(o)||j(te=>wt(te,ie,{attention:null}))});return Promise.all(a.map(ie=>(pe(ie.name),Q.containers(ie.name,!0).then(te=>{!F.current||!G.current.isCurrent(o)||j(De=>wt(De,ie.name,{containers:te.containers??[],error:"",loaded:!0}))}).catch(te=>{!F.current||!G.current.isCurrent(o)||j(De=>wt(De,ie.name,{error:te instanceof Error?te.message:String(te),loaded:!0}))}).finally(S))))},[a]);L(()=>{pt.current=mt},[mt]);let qr=de(()=>jt(o=>o+1),[]),Oe=de(()=>{ze(!1),oe([]),Y(""),fe(!1)},[]),Yr=()=>{if(ge){Oe();return}oe([]),fe(!1),ze(!0)},Xr=o=>oe(g=>Ba(g,o.id));L(()=>{if(!ge)return;let o=g=>{g.key==="Escape"&&Oe()};return document.addEventListener("keydown",o),()=>document.removeEventListener("keydown",o)},[ge,Oe]),L(()=>{ge&&oe(o=>Aa(o,E))},[E,ge]);let $r=o=>{f(o),D(""),w("containers"),Pe(null),Oe(),Xe({}),t.onTargetChange?.(Ie(o))},Zr=(o,g)=>{f(o),D(""),w("containers"),Oe(),Xe({}),Pe({id:g.id,tab:"overview",item:g}),t.onTargetChange?.(Ie(o))},vt=de(()=>{p==="overview"?wn():p==="images"?ft():p==="networks"?Kt():p==="volumes"?Gt():mt(),jt(o=>o+1)},[p,wn,mt,ft,Kt,Gt]);L(()=>{p!=="overview"&&d!==""&&vt()},[d,Ne,p]);let Qr=a.map(o=>o.name).join("\0");L(()=>{p==="overview"&&wn()},[p,Qr]),L(()=>{if(!Te||p!=="overview"&&(d===""||p==="images"))return;let o=setInterval(vt,Math.max(2,n?.pollIntervalSec??5)*1e3);return()=>clearInterval(o)},[Te,vt,d,n,p]);let eo=()=>Ve==="open"?"\u5B9E\u65F6\u63A5\u6536\u4E2D\uFF08docker events\uFF09":Ve==="connecting"?"\u6B63\u5728\u8FDE\u63A5\u4E8B\u4EF6\u6D41\u2026":Ve==="reconnecting"?"\u8FDE\u63A5\u4E2D\u65AD\uFF0C\u6B63\u5728\u81EA\u52A8\u91CD\u8FDE\u2026":Ve==="closed"?"\u4E8B\u4EF6\u6D41\u5DF2\u65AD\u5F00":Ve==="unsupported"?"\u5F53\u524D\u73AF\u5883\u4E0D\u652F\u6301 EventSource":"\u4E8B\u4EF6\u6D41";L(()=>{if(!ht||p!=="containers"||d==="")return;if(typeof EventSource!="function"){he("unsupported");return}Pt.current!==d&&(Pt.current=d,gt([])),he("connecting");let o=Ua(Ka,()=>{let xe=pt.current;xe!==null&&xe()}),g=!1,S=new EventSource($t("/events/stream",{target:d})),pe=!1,ie=()=>{if(!pe){pe=!0;try{S.close()}catch{}}},te=xe=>{let Me=null;try{Me=JSON.parse(xe.data)}catch{return}Me===null||typeof Me!="object"||(gt(Yt=>Ga(Yt,Me,Fa)),o.schedule())},De=xe=>{let Me=null;try{Me=JSON.parse(xe.data)}catch{}let Yt=Me!==null&&typeof Me.code=="number"?Me.code:null;he("closed"),ae("\u4E8B\u4EF6\u6D41\u5DF2\u7ED3\u675F"+(Yt===null?"":"\uFF08\u9000\u51FA\u7801 "+String(Yt)+"\uFF09")+"\uFF0C\u5217\u8868\u56DE\u5230 AUTO REFRESH / \u624B\u52A8\u5237\u65B0"),ie()},qt=xe=>{if(typeof xe.data=="string"&&xe.data!==""){he("closed"),ie();return}he(S.readyState===2?"closed":"reconnecting")};return S.addEventListener("event",te),S.addEventListener("end",De),S.addEventListener("error",qt),S.onopen=()=>{if(he("open"),g){let xe=pt.current;xe!==null&&xe()}g=!0},()=>{ie(),o.cancel()}},[ht,p,d]),L(()=>{if(Z==="")return;let o=setTimeout(()=>ae(""),4e3);return()=>clearTimeout(o)},[Z]);let Wt=(o,g)=>{let S=Ca(o.name);navigator.clipboard.writeText(S).then(()=>{ae("\u5DF2\u590D\u5236\uFF1A"+S+(g===void 0?"":"\uFF08"+g+"\uFF09"))}).catch(()=>ae("\u590D\u5236\u5931\u8D25\uFF0C\u8BF7\u624B\u52A8\u6267\u884C\uFF1A"+S))},to=o=>{let g=Ca(o.name);if(qe===null){let te=document.querySelector("[data-dsh-tty-entry]")!==null;Wt(o,te?"\u7EC8\u7AEF\u9762\u677F\u7248\u672C\u8FC7\u65E7\uFF08\u4EA4\u4E92\u5F0F\u8FDB\u5165\u5BB9\u5668\u9700\u8981 dsh-tty \u2265 0.14.0\uFF09\uFF0C\u547D\u4EE4\u5DF2\u590D\u5236\uFF0C\u53EF\u7C98\u8D34\u5230\u7CFB\u7EDF\u7EC8\u7AEF\u6267\u884C":"\u672A\u5B89\u88C5 dsh-tty \u7EC8\u7AEF\u9762\u677F\uFF0C\u547D\u4EE4\u5DF2\u590D\u5236\uFF0C\u53EF\u7C98\u8D34\u5230\u7CFB\u7EDF\u7EC8\u7AEF\u6267\u884C\uFF08\u88C5 dsh-tty \u540E\u53EF\u76F4\u63A5\u5728\u6B64\u5F00\u7EC8\u7AEF\uFF09");return}let S=(n?.targets??[]).find(te=>te.name===d),pe=o.name+" \xB7 exec",ie=S===void 0||S.kind==="local"?{command:g,label:pe}:typeof S.book=="string"&&S.book!==""?{book:S.book,command:g,label:pe}:(S.auth??"agent")==="agent"?{spec:{host:S.host,port:S.port,username:S.username,auth:"agent",agentForward:S.agentForward===!0},command:g,label:pe}:null;if(ie===null){Wt(o,"\u5185\u8054\u76EE\u6807\u7528\u4E86 key/password \u8BA4\u8BC1\uFF0C\u6D4F\u89C8\u5668\u7AEF\u62FF\u4E0D\u5230\u51ED\u8BC1");return}if(t.docked===!0||t.carrier==="tab"){try{qe.open(ie)}catch(te){Wt(o,te instanceof Error?te.message:String(te))}return}if(typeof qe.mount=="function"&&Number(qe.version??0)>=2){W({label:pe,options:ie}),ue(!1);return}try{qe.open(ie),t.onClose()}catch(te){Wt(o,te instanceof Error?te.message:String(te))}},ka=o=>Xe(g=>{if(g[o]===void 0)return g;let S={...g};return delete S[o],S}),bt=(o,g)=>{zt(!0);let S=()=>{zt(!1),Se(null)};Promise.resolve().then(o).then(async()=>{if(S(),g!==void 0)try{await g()}catch(pe){D(pe.message)}},pe=>{S(),D(pe.message)})},no=(o,g)=>{Ft[g.id]===void 0&&Se({title:o==="remove"?"\u5220\u9664\u5BB9\u5668":o==="stop"?"\u505C\u6B62\u5BB9\u5668":o==="start"?"\u542F\u52A8\u5BB9\u5668":"\u91CD\u542F\u5BB9\u5668",text:o==="remove"?`\u786E\u5B9A\u5220\u9664\u5BB9\u5668 ${g.name}\uFF1F\u5BB9\u5668\u7684\u53EF\u5199\u5C42\u4E0E\u914D\u7F6E\u4F1A\u88AB\u5220\u9664\uFF08\u547D\u540D\u6570\u636E\u5377\u4FDD\u7559\uFF09\uFF0C\u6B64\u64CD\u4F5C\u4E0D\u53EF\u6062\u590D\u3002`:`\u786E\u5B9A\u5BF9\u5BB9\u5668 ${g.name} \u6267\u884C${o==="stop"?"\u505C\u6B62":o==="start"?"\u542F\u52A8":"\u91CD\u542F"}\u64CD\u4F5C\uFF1F`,confirmLabel:o==="remove"?"\u5220\u9664":"\u786E\u5B9A",run:()=>bt(async()=>{Xe(S=>({...S,[g.id]:o}));try{let S=await Q.action(d,o,g.id);ae(`${S.result.action} ${g.name}\uFF1A${S.result.message}`)}catch(S){throw ka(g.id),S}},async()=>{try{await mt()}finally{ka(g.id)}})})},ao=o=>{let g=sn(o);Se({title:"\u5220\u9664\u955C\u50CF",text:"\u786E\u5B9A\u5220\u9664\u955C\u50CF "+g+"\uFF1F\u955C\u50CF\u88AB\u5BB9\u5668\u6216\u5B50\u955C\u50CF\u5F15\u7528\u65F6\u4F1A\u5931\u8D25\uFF1B\u5220\u9664\u540E\u9700\u8981\u91CD\u65B0\u62C9\u53D6\u6216\u6784\u5EFA\u624D\u80FD\u6062\u590D\uFF0C\u4E14\u4E0D\u53EF\u64A4\u9500\u3002",confirmLabel:"\u5220\u9664",run:()=>bt(async()=>{let S=await Q.imageRemove(d,g);ae("\u5DF2\u5220\u9664 "+g+"\uFF1A"+S.result.message),U!==null&&sn(U)===g&&q(null),await ft()})})},ro=()=>{Se({title:"\u6E05\u7406 dangling \u955C\u50CF",text:"\u6E05\u7406\u8BE5\u76EE\u6807\u4E0A\u6240\u6709\u65E0\u6807\u7B7E\uFF08<none>:<none>\uFF09\u7684\u955C\u50CF\u5C42\uFF0C\u91CA\u653E\u78C1\u76D8\u7A7A\u95F4\uFF1B\u4E0D\u4F1A\u5220\u9664\u6709 tag \u7684\u955C\u50CF\u3002",confirmLabel:"\u6E05\u7406",run:()=>bt(async()=>{let o=await Q.imagePrune(d),g=String(o.result.message).trim().split(`
`).filter(S=>S!=="");ae("\u5DF2\u6E05\u7406 dangling \u955C\u50CF\uFF1A"+(g.length===0?"ok":g[g.length-1])),await ft()})})},oo=()=>{Se({title:"\u6E05\u7406\u672A\u4F7F\u7528\u7684\u7F51\u7EDC",text:"\u6E05\u7406\u8BE5\u76EE\u6807\u4E0A\u6240\u6709\u6CA1\u6709\u5BB9\u5668\u63A5\u5165\u7684\u7F51\u7EDC\u3002compose \u521B\u5EFA\u7684\u9879\u76EE\u7F51\u7EDC\u4E5F\u5728\u5176\u4E2D\uFF08\u4E0B\u6B21 up \u4F1A\u91CD\u5EFA\uFF09\uFF0C\u4F46\u6B63\u5728\u8DD1\u7684\u9879\u76EE\u4F1A\u77ED\u6682\u5931\u53BB\u7F51\u7EDC\u3002",confirmLabel:"\u6E05\u7406",run:()=>bt(async()=>{let o=await Q.networkPrune(d),g=String(o.result.message).trim().split(`
`).filter(S=>S!=="");ae("\u5DF2\u6E05\u7406\u672A\u4F7F\u7528\u7F51\u7EDC\uFF1A"+(g.length===0?"ok":g[g.length-1])),await Kt()})})},io=()=>{Se({title:"\u6E05\u7406\u672A\u4F7F\u7528\u7684\u5377",text:"\u6E05\u7406\u8BE5\u76EE\u6807\u4E0A\u6240\u6709\u6CA1\u6709\u88AB\u5BB9\u5668\u4F7F\u7528\u7684\u5377\u2014\u2014\u5377\u91CC\u7684\u6570\u636E\u4F1A\u4E00\u8D77\u5220\u9664\u4E14\u4E0D\u53EF\u6062\u590D\u3002docker \u2265 23 \u53EA\u5220\u533F\u540D\u5377\uFF08\u4E0D\u5E26 --all\uFF09\uFF0C\u66F4\u8001\u7684\u7248\u672C\u4F1A\u8FDE\u547D\u540D\u5377\u4E00\u8D77\u5220\uFF1B\u6267\u884C\u524D\u8BF7\u786E\u8BA4\u6CA1\u6709\u9700\u8981\u4FDD\u7559\u7684\u6570\u636E\u5377\u3002",confirmLabel:"\u6E05\u7406",run:()=>bt(async()=>{let o=await Q.volumePrune(d),g=String(o.result.message).trim().split(`
`).filter(S=>S!=="");ae("\u5DF2\u6E05\u7406\u672A\u4F7F\u7528\u5377\uFF1A"+(g.length===0?"ok":g[g.length-1])),await Gt()})})},ga=(o,g)=>S=>{o(),ae(S),g()},Jt=Je===null?null:E.find(o=>o.id===Je.id)??Je.item,$e=E.filter(o=>{if(We==="running"&&!(o.state==="running"||o.state==="paused"||o.state==="restarting")||We==="stopped"&&o.state==="running"||We==="unhealthy"&&o.health!=="unhealthy")return!1;let g=ve.trim().toLowerCase();return g===""?!0:o.name.toLowerCase().includes(g)||o.image.toLowerCase().includes(g)||o.id.toLowerCase().includes(g)}),Nn=C.filter(o=>{let g=Vt.trim().toLowerCase();return g===""||o.reference.toLowerCase().includes(g)||o.id.toLowerCase().includes(g)}),Sn=m.filter(o=>{let g=y.trim().toLowerCase();return g===""||o.name.toLowerCase().includes(g)||o.driver.toLowerCase().includes(g)||o.id.toLowerCase().includes(g)}),Cn=_.filter(o=>{let g=N.trim().toLowerCase();return g===""||o.name.toLowerCase().includes(g)||o.driver.toLowerCase().includes(g)||o.mountpoint.toLowerCase().includes(g)}),lo=()=>i("div",{className:"dk_switchPill",title:"\u6B63\u5728\u5207\u6362\u5230 "+d+ha(d)+"\u3002\u4E0B\u9762\u4ECD\u662F "+R+ha(R)+"\u7684\u6570\u636E\uFF0C\u5207\u6362\u5B8C\u6210\u524D\u4E0D\u53EF\u64CD\u4F5C\u3002",children:[e("span",{className:"dk_spin dk_spinSm"}),i("span",{className:"dk_switchText",children:[e("span",{children:"\u6B63\u5728\u5207\u6362\u5230"}),e("strong",{children:d}),e("span",{className:"dk_switchDot",children:"\xB7"}),i("span",{className:"dk_switchSub",children:[e("span",{children:"\u5F53\u524D\u663E\u793A\uFF1A"}),e("span",{className:"dk_switchName",children:R})]})]})]},"switchPill"),ha=o=>{let g=a.find(pe=>pe.name===o),S=g===void 0||typeof g.label!="string"?"":g.label;return S===""||S===o?"":"\uFF08"+S+"\uFF09"},pa=R!==""&&R!==d&&!x,Ie=o=>{let g=a.find(S=>S.name===o);return g===void 0||g.label===void 0?o:o+" \xB7 "+g.label},_t=()=>we?e("div",{className:"dk_empty",children:[e("span",{className:"dk_spin"}),e("div",{children:"\u8BFB\u53D6\u4E2D\u2026"})]}):d===""?x?i("div",{className:"dk_empty",children:[e("div",{className:"dk_emptyTitle",children:"\u5F53\u524D\u4F1A\u8BDD\u4E3B\u673A\u8FD8\u4E0D\u662F Docker \u76EE\u6807"}),e("div",{className:"dk_emptyHint",children:"\u6309\u4E0A\u9762\u7684\u63D0\u793A\u5230 \u8BBE\u7F6E \u2192 \u63D2\u4EF6 \u2192 Docker \u5BB9\u5668\u9762\u677F \u6DFB\u52A0\u4E00\u6761\u76EE\u6807\uFF08\u63A8\u8350\u76F4\u63A5\u9009\u8FDE\u63A5\u7C3F\u6761\u76EE\uFF09\uFF0C\u4FDD\u5B58\u540E\u56DE\u5230\u8FD9\u91CC\u5237\u65B0\u3002\u4E3A\u907F\u514D\u5F20\u51A0\u674E\u6234\uFF0C\u9762\u677F\u4E0D\u4F1A\u81EA\u52A8\u5207\u5230\u5176\u4ED6\u76EE\u6807\u3002"})]}):i("div",{className:"dk_empty",children:[e("div",{className:"dk_emptyTitle",children:"\u8FD8\u6CA1\u6709\u914D\u7F6E Docker \u76EE\u6807"}),e("div",{className:"dk_emptyHint",children:"\u5230 \u8BBE\u7F6E \u2192 \u63D2\u4EF6 \u2192 Docker \u5BB9\u5668\u9762\u677F \u6DFB\u52A0\u4E00\u4E2A\u76EE\u6807\uFF1A\u672C\u673A\u76F4\u63A5\u9009\u300C\u672C\u673A\u300D\uFF1B\u8FDC\u7A0B\u4E3B\u673A\u53EF\u4EE5\u5F15\u7528 tty \u7EC8\u7AEF\u9762\u677F\u7684\u8FDE\u63A5\u7C3F\u6761\u76EE\u3002"})]}):Ce!==""&&E.length===0?i("div",{className:"dk_empty",children:[e("div",{className:"dk_emptyTitle",children:"\u8FD9\u4E2A\u76EE\u6807\u7684\u6570\u636E\u6CA1\u8BFB\u5230"}),e("div",{className:"dk_emptyHint",children:"\u4E0A\u9762\u7684\u9519\u8BEF\u6761\u91CC\u6709\u539F\u56E0\uFF08\u76EE\u6807\u4E0D\u53EF\u8FBE / docker \u672A\u8FD0\u884C / \u6743\u9650\u4E0D\u8DB3\uFF09\u3002\u4FEE\u597D\u540E\u70B9\u53F3\u4E0A\u89D2\u5237\u65B0\u5373\u53EF\u3002"})]}):i("div",{className:"dk_empty",children:[e("div",{className:"dk_emptyTitle",children:p==="images"?"\u6CA1\u6709\u955C\u50CF":p==="compose"?"\u6CA1\u6709 Compose \u9879\u76EE":p==="networks"?"\u6CA1\u6709\u7F51\u7EDC":p==="volumes"?"\u6CA1\u6709\u5377":"\u6CA1\u6709\u5BB9\u5668"}),e("div",{className:"dk_emptyHint",children:ve.trim()===""?"\u76EE\u6807\u4E0A\u6CA1\u6709\u5339\u914D\u7684\u6570\u636E\uFF0C\u6216\u7B5B\u9009\u6761\u4EF6\u8FC7\u7A84\u3002":"\u6CA1\u6709\u5339\u914D\u300C"+ve.trim()+"\u300D\u7684\u7ED3\u679C\u3002"})]}),so=()=>{if(p==="overview")return Vn(za(O),{onOpenTarget:$r,onOpenContainer:Zr});if(p==="images")return i("div",{className:"dk_imagesView",children:[Nn.length===0?_t():e("div",{className:"dk_tableWrap",children:i("table",{className:"dk_images",children:[e("thead",{children:i("tr",{children:[e("th",{children:"\u955C\u50CF"}),e("th",{children:"\u5927\u5C0F"}),e("th",{children:"\u521B\u5EFA"}),e("th",{children:"ID"}),e("th",{className:"dk_colActions",children:"\u64CD\u4F5C"})]})}),e("tbody",{children:Nn.map(o=>i("tr",{children:[e("td",{className:"dk_mono",title:o.reference,children:o.dangling?"<none>\uFF08dangling\uFF09":o.reference}),e("td",{children:o.sizeText===""?o.size===null?"\u2014":Qt(o.size):o.sizeText}),e("td",{children:o.createdSince}),e("td",{className:"dk_mono",children:o.shortId}),e("td",{className:"dk_colActions",children:i("div",{className:"dk_rowActions",children:[e($,{icon:Eo,title:"\u67E5\u770B\u955C\u50CF\u8BE6\u60C5\uFF08\u5C42 / \u6784\u5EFA\u5386\u53F2\uFF09",onClick:()=>q(o)},"inspect"),e($,{icon:tn,danger:!0,disabled:n?.allowMutations!==!0,title:n?.allowMutations===!0?"\u5220\u9664\u955C\u50CF\uFF08\u4E0D\u53EF\u6062\u590D\uFF09":"\u9700\u8981\u6253\u5F00\u300C\u5141\u8BB8\u53D8\u66F4\u64CD\u4F5C\u300D",onClick:()=>ao(o)},"remove")]})},"actions")]},o.id+o.reference))})]})})]});if(p==="compose"){let o=cn($e);return o.length===0?_t():e(Nr,{groups:o,onOpen:g=>be({project:g})})}return p==="networks"?i("div",{className:"dk_imagesView",children:[Sn.length===0?_t():e("div",{className:"dk_tableWrap",children:i("table",{className:"dk_images",children:[e("thead",{children:i("tr",{children:[e("th",{children:"\u540D\u79F0"}),e("th",{children:"\u9A71\u52A8"}),e("th",{children:"\u8303\u56F4"}),e("th",{children:"\u5C5E\u6027"}),e("th",{children:"ID"})]})}),e("tbody",{children:Sn.map(o=>i("tr",{className:"dk_rowClickable",onClick:()=>ke(o),title:"\u67E5\u770B\u7F51\u7EDC\u8BE6\u60C5",children:[e("td",{className:"dk_mono",title:o.name,children:o.name}),e("td",{children:o.driver===""?"\u2014":o.driver}),e("td",{children:o.scope===""?"\u2014":o.scope}),e("td",{children:o.internal?e("span",{className:"dk_badge","data-state":"paused",children:"internal"}):"\u2014"}),e("td",{className:"dk_mono",title:o.id,children:o.shortId})]},o.id+o.name))})]})})]}):p==="volumes"?i("div",{className:"dk_imagesView",children:[Cn.length===0?_t():e("div",{className:"dk_tableWrap",children:i("table",{className:"dk_images",children:[e("thead",{children:i("tr",{children:[e("th",{children:"\u540D\u79F0"}),e("th",{children:"\u9A71\u52A8"}),e("th",{children:"\u8303\u56F4"}),e("th",{children:"\u6302\u8F7D\u70B9"})]})}),e("tbody",{children:Cn.map(o=>i("tr",{className:"dk_rowClickable",onClick:()=>me(o),title:"\u67E5\u770B\u5377\u8BE6\u60C5",children:[e("td",{className:"dk_mono",title:o.name,children:o.name}),e("td",{children:o.driver===""?"\u2014":o.driver}),e("td",{children:o.scope===""?"\u2014":o.scope}),e("td",{className:"dk_mono dk_pathCell",title:o.mountpoint,children:o.mountpoint===""?"\u2014":o.mountpoint})]},o.name))})]})})]}):$e.length===0?_t():e("div",{className:"dk_grid",key:R===""?"first":R,children:$e.map(o=>e(ar,{item:o,selected:Je!==null&&o.id===Je.id,allowMutations:n?.allowMutations===!0,pickMode:ge,picked:M.includes(o.id),pending:Ft[o.id],onTogglePick:Xr,onOpen:(g,S)=>Pe({id:g.id,tab:S,item:g}),onExec:to,onAction:no,onCopyExec:g=>{navigator.clipboard.writeText("docker exec -it "+g.name+" sh").then(()=>ae("\u5DF2\u590D\u5236\uFF1Adocker exec -it "+g.name+" sh")).catch(()=>ae("\u590D\u5236\u5931\u8D25\uFF0C\u8BF7\u624B\u52A8\u590D\u5236"))}},o.id))})},Le=t.docked===!0,ma=t.carrier==="tab",co=n??{pollIntervalSec:5,logTailDefault:200,allowExec:!1,allowMutations:!1,execTimeoutSec:30},yt=ja(E,M),fa=Mo(d),Ut=fa?Bn:an,uo=Ra(yt.length,fa),va=yt.length>0?yt[0]:null,ko=Da($e,M,va,Ut),go=o=>{let g=Pa($e,M,o,va,Ut);oe(g.ids),g.skipped>0?Y("\u5DF2\u65B0\u589E "+String(g.added)+" \u4E2A\uFF0C\u53E6\u6709 "+String(g.skipped)+" \u4E2A\u8D85\u51FA\u4E0A\u9650\uFF08\u6700\u591A "+String(Ut)+" \u4E2A\u6D41\uFF09\u672A\u9009"):g.added===0?Y("\u6CA1\u6709\u53EF\u65B0\u589E\u7684\u5BB9\u5668\uFF08\u5DF2\u88AB\u52FE\u9009\u6216\u4E0D\u5728\u5F53\u524D\u7B5B\u9009\u7ED3\u679C\u91CC\uFF09"):Y("\u5DF2\u65B0\u589E "+String(g.added)+" \u4E2A")},ho=Ae===null?[]:cn(E).find(o=>o.project===Ae.project)?.items??[],ba=Jt!==null?e(fr,{item:Jt,target:d,targetLabel:Ie(d),config:co,initialTab:Je.tab,refreshToken:Dt,onBack:()=>Pe(null),onRefresh:qr,onClose:Ke,docked:Le},"detail"):U!==null?e(vr,{item:C.find(o=>o.id===U.id)??U,target:d,targetLabel:Ie(d),onBack:()=>q(null),onClose:Ke,docked:Le},"imageDetail"):He?e(wr,{target:d,targetLabel:Ie(d),allowMutations:n?.allowMutations===!0,onBack:()=>Ge(!1),onDone:ft,onClose:Ke,docked:Le},"pull"):Ae!==null?e(Sr,{project:Ae.project,items:ho,target:d,targetLabel:Ie(d),onBack:()=>be(null),onClose:Ke,docked:Le},"composeDetail"):rt?e(Mr,{items:yt,target:d,targetLabel:Ie(d),onBack:Oe,onClose:Ke,docked:Le},"aggregate"):re!==null?e(br,{item:re,target:d,targetLabel:Ie(d),allowMutations:n?.allowMutations===!0,onBack:()=>ke(null),onRemoved:ga(()=>ke(null),Kt),onClose:Ke,docked:Le},"networkDetail"):Ye!==null?e(_r,{item:Ye,target:d,targetLabel:Ie(d),allowMutations:n?.allowMutations===!0,onBack:()=>me(null),onRemoved:ga(()=>me(null),Gt),onClose:Ke,docked:Le},"volumeDetail"):null,po=[ba!==null?[ba,ye===null?null:e(it,{title:ye.title,text:ye.text,confirmLabel:ye.confirmLabel,busy:Ht,onCancel:()=>Se(null),onConfirm:ye.run},"confirm")]:[Le?null:i("div",{className:"dk_header",children:[e("span",{className:"dk_titleIcon",dangerouslySetInnerHTML:{__html:Ea}}),e("span",{className:"dk_title",children:"Docker \u5BB9\u5668"}),n?.allowMutations===!0?null:e("span",{className:"dk_badge","data-state":"paused",children:"\u53EA\u8BFB\u6A21\u5F0F"}),e("span",{className:"dk_headerSpacer"}),Jt!==null?null:e("button",{type:"button",className:"dk_iconBtn",title:"\u5237\u65B0\u5217\u8868","data-spin":we?"1":void 0,onClick:vt,children:e("span",{className:"dk_iconGlyph",dangerouslySetInnerHTML:{__html:Qe}})}),e("button",{type:"button",className:"dk_iconBtn",title:"\u5173\u95ED\u9762\u677F",onClick:Ke,children:e("span",{dangerouslySetInnerHTML:{__html:Re}})})]}),Jt!==null?null:i("div",{className:"dk_toolbar",children:[e("select",{className:"dk_select",value:p==="overview"?"":d,onChange:o=>{f(o.target.value),D(""),w("containers"),Pe(null),Oe(),Xe({}),t.onTargetChange?.(Ie(o.target.value))},children:[...p==="overview"?[e("option",{value:"",children:"\uFF08\u603B\u89C8 \xB7 \u5168\u90E8\u76EE\u6807\uFF09"},"__overview")]:d===""?[e("option",{value:"",children:"\uFF08\u672A\u9009\u62E9\u76EE\u6807\uFF09"},"__none")]:[],...(a.length===0&&d!==""?[{name:d,label:void 0}]:a).map(o=>e("option",{value:o.name,children:Ie(o.name)},o.name))]}),a.length<2?null:e("button",{type:"button",className:"dk_pill dk_pillOverview","data-on":p==="overview"?"1":"0",title:p==="overview"?"\u9000\u51FA\u603B\u89C8\uFF0C\u56DE\u5230\u5F53\u524D\u76EE\u6807\u7684\u5BB9\u5668\u5217\u8868":"\u4E0D\u9009\u76EE\u6807\uFF0C\u4E00\u5C4F\u770B\u5168\u90E8\u76EE\u6807\u7684\u5BB9\u5668\u6982\u51B5\uFF08\u53EA\u8BFB\uFF09",onClick:()=>{if(p!=="overview"){w("overview"),D(""),Pe(null),Oe();return}w("containers"),Pe(null),Oe()},children:"\u603B\u89C8"}),e("div",{className:"dk_seg",children:[["containers","\u5BB9\u5668"],["images","\u955C\u50CF"],["compose","Compose"],["networks","\u7F51\u7EDC"],["volumes","\u5377"]].map(([o,g])=>e("button",{type:"button",className:"dk_segBtn","data-on":p===o?"1":"0",onClick:()=>{w(o),Pe(null),q(null),be(null),ke(null),me(null),Ge(!1),Oe()},children:g},o))}),p==="containers"?e("button",{type:"button",className:"dk_pill dk_pillPick","data-on":ge?"1":"0",title:ge?"\u9000\u51FA\u9009\u62E9\u5E76\u6E05\u7A7A\u52FE\u9009\uFF08Esc\uFF09":"\u591A\u9009\u5BB9\u5668\uFF0C\u628A\u5B83\u4EEC\u7684\u65E5\u5FD7\u4E34\u65F6\u805A\u5408\u6210\u4E00\u6761\u6D41",onClick:Yr,children:ge?"\u9000\u51FA\u9009\u62E9":"\u805A\u5408\u9009\u62E9"}):null,p==="containers"?e("input",{className:"dk_input dk_search",placeholder:"\u641C\u7D22\u540D\u79F0 / \u955C\u50CF / ID",value:ve,onChange:o=>Fe(o.target.value)}):null,p==="compose"?e("input",{className:"dk_input dk_search",placeholder:"\u641C\u7D22\u9879\u76EE / \u670D\u52A1 / \u5BB9\u5668",value:ve,onChange:o=>Fe(o.target.value)}):null,p==="images"?e("input",{className:"dk_input dk_search",placeholder:"\u641C\u7D22\u955C\u50CF\uFF08\u4ED3\u5E93 / \u6807\u7B7E / ID\uFF09",value:Vt,onChange:o=>_n(o.target.value)}):null,p==="images"?e("span",{className:"dk_hint dk_searchCount",children:String(Nn.length)+" / "+String(C.length)+" \u4E2A\u955C\u50CF"}):null,p==="images"?e($,{icon:Lo,disabled:n?.allowMutations!==!0,title:n?.allowMutations===!0?"\u62C9\u53D6\u955C\u50CF\uFF08docker pull\uFF0C\u9010\u5C42\u5B9E\u65F6\u8FDB\u5EA6\uFF09":"\u62C9\u53D6\u955C\u50CF\u9700\u8981\u6253\u5F00\u300C\u5141\u8BB8\u53D8\u66F4\u64CD\u4F5C\u300D",onClick:()=>Ge(!0)},"pull"):null,p==="images"?e($,{icon:In,danger:!0,disabled:n?.allowMutations!==!0,title:n?.allowMutations===!0?"\u6E05\u7406 dangling\uFF08\u65E0\u6807\u7B7E\uFF09\u955C\u50CF":"\u6E05\u7406 dangling \u9700\u8981\u6253\u5F00\u300C\u5141\u8BB8\u53D8\u66F4\u64CD\u4F5C\u300D",onClick:ro},"prune"):null,p==="networks"?e("input",{className:"dk_input dk_search",placeholder:"\u641C\u7D22\u7F51\u7EDC\uFF08\u540D\u79F0 / \u9A71\u52A8 / ID\uFF09",value:y,onChange:o=>I(o.target.value)}):null,p==="volumes"?e("input",{className:"dk_input dk_search",placeholder:"\u641C\u7D22\u5377\uFF08\u540D\u79F0 / \u9A71\u52A8 / \u6302\u8F7D\u70B9\uFF09",value:N,onChange:o=>z(o.target.value)}):null,p==="networks"?e("span",{className:"dk_hint dk_searchCount",children:String(Sn.length)+" / "+String(m.length)+" \u4E2A\u7F51\u7EDC"}):null,p==="volumes"?e("span",{className:"dk_hint dk_searchCount",children:String(Cn.length)+" / "+String(_.length)+" \u4E2A\u5377"}):null,p==="networks"?e($,{icon:In,danger:!0,disabled:n?.allowMutations!==!0,title:n?.allowMutations===!0?"\u6E05\u7406\u672A\u4F7F\u7528\u7684\u7F51\u7EDC\uFF08docker network prune\uFF09":"\u6E05\u7406\u7F51\u7EDC\u9700\u8981\u6253\u5F00\u300C\u5141\u8BB8\u53D8\u66F4\u64CD\u4F5C\u300D",onClick:oo},"prune"):null,p==="volumes"?e($,{icon:In,danger:!0,disabled:n?.allowMutations!==!0,title:n?.allowMutations===!0?"\u6E05\u7406\u672A\u4F7F\u7528\u7684\u5377\uFF08docker volume prune\uFF0C\u4F1A\u5220\u6570\u636E\uFF09":"\u6E05\u7406\u5377\u9700\u8981\u6253\u5F00\u300C\u5141\u8BB8\u53D8\u66F4\u64CD\u4F5C\u300D",onClick:io},"prune"):null,p==="compose"?e("span",{className:"dk_hint dk_searchCount",children:String(cn($e).length)+" \u4E2A\u9879\u76EE \xB7 "+String($e.length)+" \u4E2A\u5BB9\u5668"}):null,p==="containers"?e("div",{className:"dk_seg",children:[["all","\u5168\u90E8"],["running","\u8FD0\u884C\u4E2D"],["stopped","\u5DF2\u505C\u6B62"],["unhealthy","\u4E0D\u5065\u5EB7"]].map(([o,g])=>e("button",{type:"button",className:"dk_segBtn","data-on":We===o?"1":"0",onClick:()=>vn(o),children:g},o))}):null,p==="containers"||p==="compose"||p==="overview"?i("div",{className:"dk_toolbarToggles",children:[p==="containers"||p==="compose"?e("label",{className:"dk_check",children:[e("input",{type:"checkbox",checked:Ne,onChange:o=>_e(o.target.checked)}),"\u542B\u5DF2\u505C\u6B62"]},"all"):null,e("label",{className:"dk_check",children:[e("input",{type:"checkbox",checked:Te,onChange:o=>Rt(o.target.checked)}),"\u81EA\u52A8\u5237\u65B0"]},"auto")]}):null,Le?i("div",{className:"dk_toolbarEnd",children:[n?.allowMutations!==!0?e("span",{className:"dk_badge","data-state":"paused",children:"\u53EA\u8BFB\u6A21\u5F0F"},"readonly"):null,e("button",{type:"button",className:"dk_iconBtn",title:"\u5237\u65B0\u5217\u8868","data-spin":we?"1":void 0,onClick:vt,children:e("span",{className:"dk_iconGlyph",dangerouslySetInnerHTML:{__html:Qe}})},"refresh")]}):null]}),p==="containers"&&ge?e(Ir,{count:yt.length,info:uo,presets:ko,max:Ut,notice:ee,onPreset:go,onClear:()=>{oe([]),Y("")},onRun:()=>fe(!0),onCancel:Oe},"pickBar"):null,i("div",{className:"dk_body","data-stale":pa?"1":void 0,children:[pa?e("div",{className:"dk_switchOverlay",children:lo()},"stale"):null,i("div",{className:"dk_main"+(p==="images"||p==="networks"||p==="volumes"||p==="overview"?" dk_mainImages":""),children:[Ce===""||p==="overview"?null:e(X,{title:"\u64CD\u4F5C\u5931\u8D25",hint:Ce}),Z===""?null:e(X,{kind:"info",title:Z}),t.sessionHint===void 0?null:e(X,{kind:"info",title:"\u5F53\u524D\u4F1A\u8BDD\u4E3B\u673A\u8FD8\u6CA1\u914D\u7F6E\u4E3A Docker \u76EE\u6807",hint:"\u4F1A\u8BDD\u4E3B\u673A\uFF1A"+t.sessionHint.host+(t.sessionHint.port===22?"":":"+String(t.sessionHint.port))+(t.sessionHint.book===""?"":"\uFF08\u8FDE\u63A5\u7C3F\uFF1A"+t.sessionHint.book+"\uFF09")+" \u2014 \u5230 \u8BBE\u7F6E \u2192 \u63D2\u4EF6 \u2192 Docker \u5BB9\u5668\u9762\u677F \u6DFB\u52A0\u4E00\u6761 kind=ssh \u76EE\u6807"+(t.sessionHint.book===""?"\uFF08\u586B host/username\uFF0C\u6216\u7528\u8FDE\u63A5\u7C3F\u6761\u76EE\uFF09":"\uFF0C\u76F4\u63A5\u9009\u8FDE\u63A5\u7C3F\u6761\u76EE\u300C"+t.sessionHint.book+"\u300D")+"\uFF0C\u4FDD\u5B58\u540E\u56DE\u5230\u8FD9\u91CC\u5237\u65B0\u5373\u53EF\u3002"}),n!==null&&n.allowMutations!==!0?e(X,{kind:"info",title:"\u5F53\u524D\u4E3A\u53EA\u8BFB\u6A21\u5F0F",hint:"\u5BB9\u5668\u7684\u542F\u52A8 / \u505C\u6B62 / \u91CD\u542F / \u5220\u9664\uFF0C\u4EE5\u53CA\u955C\u50CF\u3001\u7F51\u7EDC\u3001\u5377\u7684\u5220\u9664\u4E0E\u6E05\u7406\uFF0C\u90FD\u9700\u8981\u5230 \u8BBE\u7F6E \u2192 \u63D2\u4EF6 \u2192 Docker \u5BB9\u5668\u9762\u677F \u6253\u5F00\u300C\u5141\u8BB8\u53D8\u66F4\u64CD\u4F5C\u300D\u3002"}):null,p==="containers"?e(Or,{events:Bt,status:Ve,statusText:eo(),open:At,onToggle:()=>bn(o=>!o)},"activity"):null,so()]})]}),ye===null?null:e(it,{title:ye.title,text:ye.text,confirmLabel:ye.confirmLabel,busy:Ht,onCancel:()=>Se(null),onConfirm:ye.run})],se===null?null:e(Rr,{label:se.label,hostRef:V,collapsed:K,height:Ue,onToggleCollapse:()=>ue(o=>!o),onResizeStart:Ur,onClose:()=>W(null)},"execDrawer"),Jr&&se!==null?e(it,{title:"\u7ED3\u675F\u5BB9\u5668\u7EC8\u7AEF\u4F1A\u8BDD",text:"\u5173\u95ED\u9762\u677F\u4F1A\u7ED3\u675F\u300C"+se.label+"\u300D\u7684\u7EC8\u7AEF\u4F1A\u8BDD\uFF08docker exec -it \u2026\uFF09\u3002\u82E5\u53EA\u662F\u60F3\u7ED9\u65E5\u5FD7 / \u5217\u8868\u817E\u5730\u65B9\uFF0C\u5148\u70B9\u62BD\u5C49\u53F3\u4E0A\u89D2\u7684\u6298\u53E0\u6309\u94AE\u5373\u53EF\uFF0C\u4F1A\u8BDD\u4F1A\u4FDD\u6301\u8FD0\u884C\u3002",confirmLabel:"\u7ED3\u675F\u5E76\u5173\u95ED",onCancel:()=>yn(!1),onConfirm:()=>{yn(!1),t.onClose()}},"closeConfirm"):null],_a=i("div",{className:"dk_panel"+(Le?" dk_panelDock":ma?" dk_panelTab":""),"data-dock":Le?"1":void 0,ref:ua,onMouseDown:o=>o.stopPropagation(),children:po});return Le||ma?_a:i("div",{className:"dk_backdrop",onMouseDown:o=>{xn.current=o.target===o.currentTarget},onMouseUp:o=>{let g=xn.current&&o.target===o.currentTarget;xn.current=!1,g&&Ke()},children:[_a]})}function Br(t){let n=null;try{n=t.useTabInfo()}catch{}let r=()=>{try{n?.tab?.actions?.close?.()}catch{}},a=n?.tab?.navigation?.params,c=typeof a?.target=="string"?a.target:"",u=A("");c!==""&&(u.current=c);let s=u.current,d=n?.tab?.visible!==!1;return e(da.Provider,{value:d,children:e(mn,{key:s===""?"docker-tab":s,carrier:"tab",onClose:r,initialTarget:s===""?void 0:s,sessionHint:a?.sessionHint})})}function Ar(){let[t,n]=h(!1),[r,a]=h(null),[c,u]=h(!1),[s,d]=h(!1),[f,x]=h({kind:"",text:""}),p=A(0),w=de(()=>{Q.config().then(m=>{a(m.config),En(m.config),p.current=Array.isArray(m.config?.targets)?m.config.targets.length:0,u(!0)}).catch(m=>{x({kind:"error",text:"\u8BFB\u53D6\u914D\u7F6E\u5931\u8D25\uFF1A"+m.message}),u(!0)})},[]);L(()=>{t&&!c&&w()},[t,c,w]);let E=m=>a(v=>({...v,...m})),P=(m,v)=>a(_=>{let H=_.targets.slice();return H[m]={...H[m],...v},{..._,targets:H}}),R=()=>a(m=>({...m,targets:[...m.targets,{name:"\u76EE\u6807"+String(m.targets.length+1),kind:"local",book:"",host:"",port:22,username:"",auth:"agent",keyPath:"",agentForward:!1,passwordSet:!1,passphraseSet:!1}]})),J=m=>a(v=>({...v,targets:v.targets.filter((_,H)=>H!==m)})),b=m=>a(v=>({...v,hostKeys:v.hostKeys.filter(_=>!(_.host===m.host&&_.port===m.port))})),B=()=>{d(!0),x({kind:"",text:""});let m={enabled:r.enabled,announceToAgent:r.announceToAgent,dockerBin:r.dockerBin,allowMutations:r.allowMutations,allowExec:r.allowExec,execTimeoutSec:r.execTimeoutSec,pollIntervalSec:r.pollIntervalSec,logTailDefault:r.logTailDefault,maxOutputKb:r.maxOutputKb,targets:r.targets.map(v=>({name:v.name,kind:v.kind,book:v.book??"",host:v.host??"",port:Number(v.port)||22,username:v.username??"",auth:v.auth??"agent",keyPath:v.keyPath??"",...v.password===void 0||v.password===""?{}:{password:v.password},...v.passphrase===void 0||v.passphrase===""?{}:{passphrase:v.passphrase},agentForward:v.agentForward===!0})),hostKeys:r.hostKeys,...r.targets.length===0&&p.current>0?{clearTargets:!0}:{}};Q.saveConfig(m).then(v=>{a(v.config),En(v.config),p.current=Array.isArray(v.config?.targets)?v.config.targets.length:0,nn(),x(v.warning===void 0?{kind:"ok",text:"\u5DF2\u4FDD\u5B58\u5E76\u70ED\u751F\u6548"}:{kind:"error",text:v.warning})}).catch(v=>{x({kind:"error",text:"\u4FDD\u5B58\u5931\u8D25\uFF1A"+v.message})}).finally(()=>d(!1))},O=m=>e("div",{className:"dk_cardSection",children:m}),j=(m,v,_,H)=>i("div",{className:"dk_field","data-span":H===void 0?void 0:String(H),children:[e("span",{className:"dk_label",children:m}),v,_===void 0?null:e("span",{className:"dk_hint",children:_})]}),C=(m,v,_,H)=>e("input",{className:"dk_input",type:"number",min:v,max:_,value:r[m],onChange:U=>E({[m]:Number(U.target.value)})}),ne=m=>i("li",{className:"dk_settingsCard"+(t?" dk_settingsCardOpen":""),children:[i("button",{type:"button",className:"dk_settingsHead","aria-expanded":t,onClick:()=>n(v=>!v),children:[i("span",{className:"dk_settingsHeadText",children:[e("span",{className:"dk_settingsName",children:"Docker \u5BB9\u5668\u9762\u677F"}),e("span",{className:"dk_settingsDesc",children:"\u672C\u673A / SSH \u4E3B\u673A\u4E0A\u7684\u5BB9\u5668\u4E0E\u955C\u50CF\uFF1B\u9ED8\u8BA4\u53EA\u8BFB\uFF0C\u53D8\u66F4\u64CD\u4F5C\u9700\u663E\u5F0F\u5F00\u542F"})]}),e("span",{className:"dshkit_badge",children:"Kit"}),e("span",{className:"dk_settingsChevron",dangerouslySetInnerHTML:{__html:On}})]}),t?e("div",{className:"dk_settingsBody",children:m}):null]});return ne(t?!c||r===null?i("div",{className:"dk_row",children:[e("span",{className:"dk_spin"}),"\u8BFB\u53D6\u914D\u7F6E\u2026"]}):[O("\u57FA\u672C"),i("div",{className:"dk_row",children:[e("label",{className:"dk_check",children:[e("input",{type:"checkbox",checked:r.enabled,onChange:m=>E({enabled:m.target.checked})}),"\u542F\u7528\u63D2\u4EF6"]}),e("label",{className:"dk_check",children:[e("input",{type:"checkbox",checked:r.announceToAgent,onChange:m=>E({announceToAgent:m.target.checked})}),"\u5411 agent \u516C\u544A\u80FD\u529B"]})]}),i("div",{className:"dk_fieldGrid",children:[j("docker CLI",e("input",{className:"dk_input",value:r.dockerBin,onChange:m=>E({dockerBin:m.target.value})}),"\u9ED8\u8BA4 docker\uFF1Bpodman \u53EF\u586B podman"),j("\u7EDF\u8BA1\u5237\u65B0\u95F4\u9694\uFF08\u79D2\uFF09",C("pollIntervalSec",1,60)),j("\u65E5\u5FD7\u9ED8\u8BA4\u884C\u6570",C("logTailDefault",1,5e3)),j("\u8F93\u51FA\u4E0A\u9650\uFF08KB\uFF09",C("maxOutputKb",1,8192)),j("exec \u8D85\u65F6\uFF08\u79D2\uFF09",C("execTimeoutSec",1,120))]}),O("\u80FD\u529B\u5F00\u5173\uFF08\u9ED8\u8BA4\u5173\u95ED\uFF09"),i("div",{className:"dk_row",children:[e("label",{className:"dk_check",children:[e("input",{type:"checkbox",checked:r.allowMutations,onChange:m=>E({allowMutations:m.target.checked})}),"\u5141\u8BB8\u53D8\u66F4\u64CD\u4F5C\uFF08\u5BB9\u5668\u542F\u505C\u5220\u3001\u955C\u50CF\u62C9\u53D6 / \u5220\u9664 / \u6E05\u7406\uFF09"]}),e("label",{className:"dk_check",children:[e("input",{type:"checkbox",checked:r.allowExec,onChange:m=>E({allowExec:m.target.checked})}),"\u5141\u8BB8 exec\uFF08\u5728\u5BB9\u5668\u5185\u6267\u884C\u547D\u4EE4\uFF09"]})]}),e("span",{className:"dk_hint",children:"docker socket \u7B49\u4EF7\u4E8E\u76EE\u6807\u4E3B\u673A\u7684 root \u6743\u9650\u3002\u5F00\u542F\u540E\uFF0C\u6D4F\u89C8\u5668\u9762\u677F\u4E0E agent \u90FD\u80FD\u6267\u884C\u5BF9\u5E94\u64CD\u4F5C\uFF0C\u8BF7\u53EA\u5728\u53EF\u4FE1\u73AF\u5883\u4E0B\u6253\u5F00\u3002"}),O("\u76EE\u6807"),...r.targets.map((m,v)=>i("div",{className:"dk_targetRow",children:[e("input",{className:"dk_input",value:m.name,placeholder:"\u76EE\u6807\u540D",onChange:_=>P(v,{name:_.target.value})}),e("select",{className:"dk_select",value:m.kind,onChange:_=>P(v,{kind:_.target.value}),children:[e("option",{value:"local",children:"\u672C\u673A"}),e("option",{value:"ssh",children:"SSH \u4E3B\u673A"})]}),m.kind==="local"?e("span",{className:"dk_hint",children:"\u5BBF\u4E3B\u6240\u5728\u673A\u5668\u4E0A\u7684 docker"}):i("div",{className:"dk_row",style:{gridColumn:"span 1"},children:[e("select",{className:"dk_select",value:m.book??"",onChange:_=>P(v,{book:_.target.value}),children:[e("option",{value:"",children:r.ttyBooks.length===0?"\uFF08\u65E0 tty \u8FDE\u63A5\u7C3F\uFF0C\u8BF7\u586B\u5185\u8054\u4FE1\u606F\uFF09":"\uFF08\u4E0D\u7528\u8FDE\u63A5\u7C3F\uFF0C\u624B\u586B\uFF09"}),...r.ttyBooks.map(_=>e("option",{value:_,children:"\u8FDE\u63A5\u7C3F\uFF1A"+_},_))]})]}),e("button",{type:"button",className:"dk_btn dk_btnDanger",onClick:()=>J(v),children:"\u5220\u9664"}),m.kind==="ssh"&&(m.book??"")===""?i("div",{className:"dk_targetInline",children:[e("input",{className:"dk_input",placeholder:"host",value:m.host??"",onChange:_=>P(v,{host:_.target.value})}),e("input",{className:"dk_input",placeholder:"22",title:"\u7AEF\u53E3",value:m.port??22,onChange:_=>P(v,{port:Number(_.target.value)||22})}),e("input",{className:"dk_input",placeholder:"username",value:m.username??"",onChange:_=>P(v,{username:_.target.value})}),e("select",{className:"dk_select",value:m.auth??"agent",onChange:_=>P(v,{auth:_.target.value}),children:[e("option",{value:"agent",children:"ssh-agent"}),e("option",{value:"key",children:"\u79C1\u94A5"}),e("option",{value:"password",children:"\u5BC6\u7801"})]}),(m.auth??"agent")==="key"?e("input",{className:"dk_input dk_credential",placeholder:"~/.ssh/id_ed25519",value:m.keyPath??"",onChange:_=>P(v,{keyPath:_.target.value})}):null,(m.auth??"agent")==="password"?e("input",{className:"dk_input dk_credential",type:"password",placeholder:m.passwordSet===!0?"\uFF08\u5DF2\u8BBE\u7F6E\uFF0C\u7559\u7A7A\u4FDD\u6301\u4E0D\u53D8\uFF09":"env:SSH_PASSWORD",value:m.password??"",onChange:_=>P(v,{password:_.target.value})}):null,e("label",{className:"dk_check",children:[e("input",{type:"checkbox",checked:m.agentForward===!0,onChange:_=>P(v,{agentForward:_.target.checked})}),"agent forwarding"]})]}):null]},String(v)+m.name)),i("div",{className:"dk_row",children:[e("button",{type:"button",className:"dk_btn",onClick:R,children:"\u6DFB\u52A0\u76EE\u6807"}),e("span",{className:"dk_hint",children:"SSH \u76EE\u6807\u63A8\u8350\u76F4\u63A5\u9009 tty \u7EC8\u7AEF\u9762\u677F\u7684\u8FDE\u63A5\u7C3F\u6761\u76EE\uFF08\u51ED\u8BC1\u53EA\u9700\u7EF4\u62A4\u4E00\u5904\uFF09\uFF1B\u624B\u586B\u65F6\u5BC6\u7801 / \u53E3\u4EE4\u5EFA\u8BAE\u5199 env:VAR\u3002"})]}),O("SSH \u4E3B\u673A\u5BC6\u94A5\u8BB0\u5F55\uFF08TOFU\uFF09"),...r.hostKeys.length===0?[e("span",{className:"dk_hint",children:"\u6682\u65E0\u8BB0\u5F55 \u2014 \u9996\u6B21 SSH \u8FDE\u63A5\u6210\u529F\u540E\u81EA\u52A8\u8BB0\u5F55\u4E3B\u673A\u6307\u7EB9\uFF08\u82E5 tty \u5DF2\u8BB0\u5F55\u540C\u4E00\u4E3B\u673A\uFF0C\u4F1A\u76F4\u63A5\u590D\u7528\uFF09\u3002"},"none")]:r.hostKeys.map(m=>i("div",{className:"dk_targetRow",children:[e("span",{children:m.host+":"+String(m.port)}),e("span",{className:"dk_hint",style:{gridColumn:"span 2",wordBreak:"break-all"},children:"sha256:"+m.fingerprint}),e("button",{type:"button",className:"dk_btn",onClick:()=>b(m),children:"\u5220\u9664"})]},m.host+":"+String(m.port))),e("span",{className:"dk_hint",children:"\u6307\u7EB9\u53D8\u66F4\u65F6\u8FDE\u63A5\u4F1A\u88AB\u62D2\u7EDD\uFF08\u9632\u4E2D\u95F4\u4EBA\uFF09\uFF1B\u786E\u8BA4\u5B89\u5168\u540E\u5220\u9664\u5BF9\u5E94\u8BB0\u5F55\u5373\u53EF\u91CD\u8FDE\u3002"}),i("div",{className:"dk_row",children:[e("button",{type:"button",className:"dk_btn dk_btnPrimary",disabled:s,onClick:B,children:s?"\u4FDD\u5B58\u4E2D\u2026":"\u4FDD\u5B58"}),e("span",{className:"dk_msg","data-kind":f.kind,children:f.text})]})]:null)}let ut=null,at=null,fn=null;function kt(){let t=at,n=ut,r=fn;if(at=null,ut=null,fn=null,n!==null&&n.remove(),t!==null&&setTimeout(()=>{try{t.unmount()}catch{}},0),r!==null)try{r.dispose()}catch{}}function Pr(t){return t!==null&&typeof t=="object"&&typeof t.appendChild=="function"}function Dr(){return typeof Ze?.mountPane=="function"&&typeof Ze.isOpen=="function"&&Number(Ze.version??0)>=1&&Ze.isOpen()===!0}let jr="dsh-docker:carrier";function Hr(){try{return window.localStorage.getItem(jr)==="modal"?"modal":"tab"}catch{return"tab"}}function sa(t){if(Hr()==="tab"&&Xt!==null)try{let n={};typeof t?.target=="string"&&t.target!==""&&(n.target=t.target),t?.sessionHint!==void 0&&(n.sessionHint=t.sessionHint),Xt.openTab(Na,{params:n});return}catch(n){console.warn("[dsh-docker] \u6253\u5F00\u53F3\u4FA7\u680F\u6807\u7B7E\u5931\u8D25\uFF0C\u56DE\u9000\u6A21\u6001\uFF1A"+(n instanceof Error?n.message:String(n)))}zr(t)}function zr(t){kt(),Tn();let n={onClose:kt,initialTarget:t?.target??"",sessionHint:t?.sessionHint};if(Dr()){let r=null;try{r=Ze.mountPane({title:"Docker \u5BB9\u5668",hint:t?.target===void 0||t.target===""?"":t.target,size:520,min:360,onClose:()=>kt()})}catch(a){r=null,console.warn("[dsh-docker] \u6302\u8F7D\u5230\u7EC8\u7AEF\u9762\u677F\u5931\u8D25\uFF0C\u56DE\u9000\u5F39\u7A97\uFF1A"+(a instanceof Error?a.message:String(a)))}if(r!==null&&Pr(r.element)){fn=r,at=T(r.element),at.render(e(mn,{...n,docked:!0,onTargetChange:a=>{try{r.setHint(a)}catch{}}}));return}}ut=document.createElement("div"),document.body.appendChild(ut),at=T(ut),at.render(e(mn,n))}function Fr(){let t=document.querySelector('[data-pane="sidebar"], [class*="sidebarCol"]');if(t!==null)return t.querySelector('[class*="logoRow"]')?.parentElement??t.firstElementChild}function Vr(t){let n=t.querySelector('button[class*="newSession"]');if(n!==null)return n;for(let r of t.children)if(r.tagName==="BUTTON")return r}function Kr(){let t=document.createElement("div");return t.dataset.dshDockerEntry="",t.className="dk_sidebarEntry",t.setAttribute("role","button"),t.setAttribute("aria-label","\u5BB9\u5668"),t.innerHTML='<span class="dk_entryIcon">'+Ea+'</span><span class="dk_entryLabel">\u5BB9\u5668</span>',t.addEventListener("click",n=>{n.preventDefault(),sa()}),t}function ca(t,n){let r=Vr(t);if(r===void 0)return!1;if(n.parentElement!==t){let a=r.closest('[class*="logoRow"]'),c=a!==null&&a.parentElement===t?a:r,u=Array.from(t.children).filter(s=>s instanceof HTMLElement&&s.matches("[data-dsh-global-search-entry], [data-dsh-rss-entry], [data-dsh-taskboard-entry], [data-dsh-ssh-entry], [data-dsh-tty-entry], [data-dsh-docker-entry]"));if(u.length>0){let s=u[u.length-1];t.insertBefore(n,s.nextSibling)}else t.insertBefore(n,c.nextElementSibling)}return!0}function Gr(){if(Tn(),document.querySelector("[data-dsh-docker-entry]")!==null)return()=>{};let t=Kr(),n,r=!1,a=()=>{if(n!==void 0&&!n.isConnected&&(u.disconnect(),n=void 0,r=!1),r){if(document.body.contains(t))return;u.disconnect(),n=void 0,r=!1}n??(n=Fr()),n!==void 0&&(r=ca(n,t),r&&u.observe(n,{childList:!0,subtree:!0}))},c=new MutationObserver(()=>{a()});c.observe(document.body,{childList:!0,subtree:!0});let u=new MutationObserver(()=>{if(n===void 0||!n.isConnected){r=!1,a();return}n.contains(t)||(r=ca(n,t))});return a(),()=>{c.disconnect(),u.disconnect(),t.remove()}}let je={};return je.inject=["slots"],je.__pick={MAX:an,SSH_MAX:Bn,PRESETS:$a,presetCounts:Da,apply:Pa,SOFT_MAX:Xa,decide:Ra,toggle:Ba,reconcile:Aa,items:ja},je.__events={LIMIT:Fa,RECENT:Va,DEBOUNCE_MS:Ka,append:Ga,actionText:Ja,timeText:Wa,debounce:Ua},je.__overview={ERROR_MAX:An,counts:er,abnormal:Pn,sortRows:tr,patch:wt,errorText:nr,data:za,body:Vn},je.__listSeq={make:Ha},je.__panel={chooseInitialTarget:Ln,readLastTarget:Ta,writeLastTarget:La,LAST_TARGET_KEY:jn},je.__aggLogs={mergeBuffered:ia,WINDOW_MS:un,splitTs:na,levelName:aa,orderByTs:kn,REORDER_TAIL:gn,reorderTail:Mt,filterByLevel:ra,exportText:oa},je.apply=t=>{Tn();let n=!1,r=()=>{};rn={set(u){if(u!==n){if(n=u,u){r=Gr();return}r(),r=()=>{},kt(),typeof en?.requestRender=="function"&&en.requestRender()}}},qa(!0);let a=t.slots.inject("settings.plugin.item",()=>t.slots.register({name:"settings.plugin.item",key:"docker",order:102},Ar));t.inject(["ttyTerminal"],u=>(qe=u.ttyTerminal??null,()=>{qe=null})),t.inject(["ttyPanel"],u=>(Ze=u.ttyPanel??null,()=>{Ze=null})),t.inject(["sessions"],u=>(st=u.sessions??null,()=>{st=null})),t.inject(["sidebarRightTabs","sidebarRight"],u=>{let s=u.sidebarRightTabs.register({id:wa,kind:Na,priority:"extension",title:()=>"Docker \u5BB9\u5668",guide:[{order:90,title:()=>"Docker \u5BB9\u5668",description:()=>"\u672C\u673A\u4E0E SSH \u4E3B\u673A\u7684\u5BB9\u5668\u3001\u955C\u50CF\u3001Compose\u3001\u7F51\u7EDC\u4E0E\u5377"}]}),d=u.slots.inject("sidebar.right.pane.tab",()=>u.slots.register({name:"sidebar.right.pane.tab",key:wa},Br));return Xt=u.sidebarRight??null,()=>{Xt=null;try{d()}catch{}try{s()}catch{}}});let c=()=>{};return nn(),t.inject(["ttyConnbar"],u=>{let s=u.ttyConnbar;s!==void 0&&(en=s,c=s.addAction(d=>{if(!on)return;let f=d?.spec??{};if(f.t!=="ssh")return;let x=typeof d?.bookName=="string"?d.bookName:"",p=Rn(f,x),w=p!==void 0?`\u6253\u5F00\u8BE5\u4E3B\u673A\u7684 Docker \u5BB9\u5668\u9762\u677F\uFF08\u76EE\u6807\uFF1A${p}\uFF09`:Be===null?"\u6253\u5F00\u5F53\u524D\u4F1A\u8BDD\u4E3B\u673A\u7684 Docker \u5BB9\u5668\u9762\u677F":"\u8BE5\u4E3B\u673A\u5C1A\u672A\u914D\u7F6E\u4E3A Docker \u76EE\u6807 \u2014 \u70B9\u51FB\u6253\u5F00\u9762\u677F\u67E5\u770B/\u914D\u7F6E";d.addAction(yo,"\u5BB9\u5668",w,()=>{(async()=>{let E=await _o(f,x),P=Number(f.port);sa({target:E??"",sessionHint:E===void 0?{host:typeof f.host=="string"?f.host:"",port:Number.isInteger(P)&&P>0?P:22,book:x}:void 0})})()})}),(async()=>{for(let d=0;d<3;d+=1){if(await nn()){typeof s.requestRender=="function"&&s.requestRender();return}await new Promise(f=>setTimeout(f,2e3))}})())}),()=>{c(),a(),rn=null,on=!1,en=null,r(),kt()}},je}});})();
