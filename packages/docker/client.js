...
`;function ia(r){let d=/^([^@]+)@(.+?)(?::(\d+))?$/.exec(typeof r=="string"?r:"");if(d!==null)return{host:d[2],port:Number(d[3]??22)}}function nr(r,d){let e=typeof r?.host=="string"?r.host:"",o=Number(r?.port);return e!==""?{host:e,port:Number.isInteger(o)&&o>0?o:22}:ia(d)}function la(r,d){if(d!==void 0)for(let e of Array.isArray(r)?r:[]){if(e===null||typeof e!="object"||e.kind!=="ssh")continue;let o=ia(e.label);if(o!==void 0&&o.host===d.host&&o.port===d.port)return e.name}}function rr(r,d){if(!(typeof r!="string"||r===""))for(let e of Array.isArray(d)?d:[]){if(e===null||typeof e!="object"||e.name!==r)continue;let o=typeof e.host=="string"?e.host.trim():"";if(o==="")return;let L=Number(e.port);return{host:o,port:Number.isInteger(L)&&L>0?L:22}}}function sa(r,d){if(r===null||typeof r!="object"||r.kind!=="ssh")return;let e=typeof r.book=="string"?r.book.trim():"";if(e==="")return;let o=Array.isArray(d)?d:[];if(o.length!==0){for(let L of o)if(L===e)return;return e}}function Zo(r){let d=r?.byId;if(!(d===null||typeof d!="object"))for(let e of Object.keys(d)){let o=d[e]?.retainedBy?.mainView??0;if(typeof o=="number"&&o>0)return e}}function ar(r){let d=r?.current;return typeof d=="string"&&d!==""?d:Zo(r)}function ir(r){return typeof r!="string"||r===""?[]:(r.endsWith(`
`)?r.slice(0,-1):r).split(`
