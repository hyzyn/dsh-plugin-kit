...
.dk_drawerDot { width: 7px; height: 7px; border-radius: 50%; flex: 0 0 auto; background: var(--dk-label-3); }
.dk_drawerDot[data-status="running"] { background: var(--dk-accent); }
.dk_drawerDot[data-status="done"] { background: var(--dk-success); }
.dk_drawerDot[data-status="stopped"] { background: var(--dk-danger); }
.dk_drawerDot[data-status="unavailable"] { background: var(--dk-warn); }

.dk_drawerTitle { font-weight: 600; color: var(--dk-label); flex: 0 0 auto; }
.dk_drawerSub { color: var(--dk-label-3); flex: 0 0 auto; }
.dk_drawerHint { color: var(--dk-label-3); overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.dk_drawerGrow { flex: 1 1 auto; min-width: 0; }
...
.dk_drawerBody {
  ...
  flex-direction: column;
  gap: var(--dk-gap-sm);
  padding: var(--dk-gap-sm) var(--dk-gap-md) var(--dk-gap-md);
  border-top: 1px solid var(--dk-border);
  font-size: 12px;
  line-height: 1.6;
}
...
.dk_drawerBody[hidden] { display: none; }

.dk_drawerItem { display: flex; gap: var(--dk-gap-sm); align-items: baseline; min-width: 0; }
.dk_drawerItem[data-kind="reasoning"] { color: var(--dk-label-3); font-style: italic; }
.dk_drawerItem[data-kind="result"] { color: var(--dk-label-2); }
.dk_drawerItem[data-kind="end"] { color: var(--dk-label-3); }
...
.dk_drawerText, .dk_drawerTool { white-space: pre-wrap; word-break: break-word; min-width: 0; }
.dk_drawerTool { font-family: var(--dk-mono); color: var(--dk-accent); }
