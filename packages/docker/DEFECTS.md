...
> **这是一份时点记录。** 2026-09-19 对 v0.6.4（HEAD `d09e40dc`）做了两轮**只读**审计：第一轮 8 路并行
...
> 证据、触发场景与修法（约 1200 行）冻结在 git 历史里：`git show 12765266:packages/docker/DEFECTS.md`（1201 行，含审计原文与两轮修复记录）。
...
**已修 125 / 待修 0**（P1×6、P2×36、P3×83；第一轮 79 + 第二轮 46）。
...
> 逐条证据与修法见 `git show 12765266:packages/docker/DEFECTS.md`；这里只留「改成了什么」，
