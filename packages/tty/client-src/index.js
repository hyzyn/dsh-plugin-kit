 ...
 * 这类本身就该是 ASCII 的资源标识**——**别拿人类起的连接名来过这里**（`HS 248` / `HS-248`
 ...
 *   例：`hsadmin@192.168.80.248:22` → `DSH_TTY_HSADMIN_192_168_80_248_PASSWORD`
 *       `root@192.168.80.248:2222` → `DSH_TTY_ROOT_192_168_80_248_2222_PASSWORD`
 *
 ...
 * 而 `HS 248` / `HS-248` / `HS_248` 折出来完全一样，只能靠哈希避免静默覆盖。资源身份没有这个死结：
