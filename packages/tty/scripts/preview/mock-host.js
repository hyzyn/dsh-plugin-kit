...
(function () {
  ...
  const CONFIG = {
    ...
    term: 'xterm-256color',
    colorTerm: 'truecolor',
    cwd: '/Users/you/coding/webproject/deepseek-harness/dsh-plugin-kit',
  ...
  const route = (url, body) => {
    ...
    if (url.indexOf('/api/dsh-tty/local-fs/list') === 0) return { ok: true, path: body && body.path ? body.path : '/Users/you/coding/webproject/deepseek-harness/dsh-plugin-kit', entries: LOCAL_FILES }
    if (url.indexOf('/api/dsh-tty/local-fs') === 0) return { ok: true, home: '/Users/you' }
