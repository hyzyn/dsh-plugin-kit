...
import { createOutputDecoder, decodeOutput, definePlugin, dshHome, isLoopbackRequest, jsYamlSchema, killProcessTree, portableSpawnPlan, readJsonBody, spawnPortable, writeFileAtomic, writeJson, } from '@hyzyn/dsh-kit';
 ...
 */
function repairExecFileError(error, command, args) {
    const failure = error;
            ...
            handler: async (req, res) => {
                ...
                try {
                    ...
                    if (runtime !== undefined)
                        runtime.sync(runtime.scope?.get());
