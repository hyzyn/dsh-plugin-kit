...
**已修 43 / 已关闭 3 / 待修 0**（CG01–CG29 + CG30/31/35/36/37/38 修于 0.4.2；CG39–CG46 修于本轮；
...
> （`dd3de493` 35、`1dc45292` 40、`7b24ce2b` 41、`79658a8f` 42）。当前 46 − 3 = **43**。
> 一处易错点：`CG15 追记` 是**同一编号的补充记录**（第 47 行表格行），不额外计入「已修」——
